...
<div class="well">
	<form action="queryBusinessByName.php" method="POST">
	请输入要查询的用户名:&nbsp;<input type="text" name="user_name"/>
...
$query_sql = "select user_id,user_name,user_when,user_where,user_department,user_main_sales,user_class,user_state from tbl_user where user_name=?";
