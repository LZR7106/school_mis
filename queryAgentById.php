...
<div class="well">
	<form action="queryAgentById.php" method="POST">
	请输入要查询的ID:&nbsp;<input type="text" name="user_id"/>
...
if(isset($_POST['user_id'])){
	...
	$query_sql = "select user_id,user_name,user_when,user_area,user_state from tbl_user where user_id = $user_id";
