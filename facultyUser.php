...
<div class="well">
	<form action="facultyUser.php" method="POST">
	请输入要查询的学院:&nbsp;<input type="text" name="faculty"/>
...
if (isset($_POST['faculty'])) {
	...
	$query_sql = "select sno,nickname,faculty,remark,email,status from student where faculty=?";
	$result = $sqlconn -> prepare($query_sql);
