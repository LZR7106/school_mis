...
<div class="btn-toolbar">
    <a class="btn btn" href="createBusiness.php" >添加代理</a>
...
$query_sql = "select user_id,user_name,user_when,user_area,user_state from tbl_user ORDER BY user_id asc limit $baserow,$offset";
